        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden animate-slide-down">
                <div class="bg-gradient-to-r from-pink-500 to-pink-600 px-6 py-6">
                    <h1 class="text-3xl font-bold text-white">📅 Schedule Site Visit</h1>
                    <p class="text-pink-100 mt-2">Book a new site visit for a customer</p>
                </div>

                <form action="{{ route('admin.site-visits.store') }}" method="POST" class="p-8 space-y-6">
                    @csrf

                    <div>
                        <label for="lead_id" class="block text-sm font-semibold text-gray-900 dark:text-white mb-2">📧 Select Lead</label>
                        <select id="lead_id" name="lead_id" required class="form-input w-full px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:outline-none" onchange="updateLeadInfo()">
                            <option value="">Choose a lead...</option>
                            @foreach($leads as $lead)
                                <option value="{{ $lead->id }}" data-email="{{ $lead->email }}" data-phone="{{ $lead->phone }}">{{ $lead->name }} ({{ $lead->email }})</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" id="scheduled_date" name="scheduled_date" required class="form-input w-full px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:outline-none" />
                    ...
                    <div>
                        ...
                        <input type="text" id="customer_name" name="customer_name" required class="form-input w-full px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:outline-none" />
                    ...
                    <div>
                        ...
                        <input type="email" id="customer_email" name="customer_email" required class="form-input w-full px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:outline-none" />
                    ...
                    <div>
                        ...
                        <input type="tel" id="customer_phone" name="customer_phone" required class="form-input w-full px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:outline-none" />
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="4" class="form-input w-full px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:outline-none" placeholder="Add any additional notes..."></textarea>
